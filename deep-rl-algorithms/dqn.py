...
class ReplayBuffer(object):
    ...
    def sample_buffer(self, batch_size):
        ...
        return state_batch, action_batch, new_state_batch, reward_batch, terminal_batch, batch_index


class Agent():
    def __init__(self, gamma, epsilon, batch_size, lr, input_dims, n_actions, eps_end=0.01, eps_dec=5e-4):
        self.gamma = gamma
        self.input_dims = input_dims
        ...
        self.Q_eval = DeepQNetwork(self.lr, n_actions=n_actions, input_dims=self.input_dims, 
    ...
    def learn(self):
        ...
        state_batch, action_batch, new_state_batch, reward_batch, terminal_batch, \
            batch_index = self.memory.sample_buffer(self.batch_size)
...
if __name__ == '__main__':
    ...
    agent = Agent(gamma=0.99, epsilon=1.0, batch_size=64, n_actions=4, eps_end=0.01, input_dims=[8], lr=3e-3)
    scores, eps_history = [], []
    n_games = 500

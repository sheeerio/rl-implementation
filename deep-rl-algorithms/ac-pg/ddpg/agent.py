...
class Agent():
    def __init__(self, lr1, lr2, tau, input_dims, n_actions, gamma=0.99,
    max_size=1000000, fc1_dims=400, fc2_dims=300, batch_size=64):
        ...
        self.actor = ActorNetwork(lr1, input_dims, fc1_dims, fc2_dims,
        n_actions, name='actor')
        self.critic = CriticNetwork(lr2, input_dims, fc1_dims, fc2_dims,
        n_actions, name='critic')
        self.target_actor = ActorNetwork(lr1, input_dims, fc1_dims, fc2_dims,
        n_actions, name='target_actor')
        self.target_critic = CriticNetwork(lr2, input_dims, fc1_dims, fc2_dims,
        n_actions, name='target_critic')

...
epsilon_greedy_player_bernoulli = epsilon_greedy_agent(
    bernoulli_bandit, 1, num_iters, 50
)
...
mea_player_bernoulli = Median_Elimination_Agent(
    bernoulli_bandit, epsilon=0.1, delta=0.1
)
ts_player_bernoulli = Thompson_Sampling_Agent(
    bernoulli_bandit, alpha=1, beta=0.01, num_iters=num_iters
)
...
ts_player_gauss = Thompson_Sampling_Agent(
    gauss_bandit, alpha=1, beta=0.01, num_iters=num_iters
)
